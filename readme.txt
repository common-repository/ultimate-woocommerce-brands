...
Donate link: https://magniumthemes.com/
...
This plugin allow you to easy add brands to your WooCommerce products on your existing site (with any WordPress theme) and include additional features like:

*   Create unlimited Brands categories for your products (you can assign multiple brands to your one product)
*   Display brand name on Product page (choose from 8 positions to display in Plugin Admin Panel)
*   Display brand name on Category pages and any Product listing pages (Choose from 6 positions to display in Plugin Admin Panel)
*   Filter product by Brands on specials brands pages (every brand on your site will have its own page with assigned products)
...
Ultimate Woocommerce Brands Live Demo: [http://plugins.wp-preview.com/woocommerce-brands/](http://plugins.wp-preview.com/woocommerce-brands/)
...
Read plugin [Documentation](http://magniumthemes.com/go/uwb-docs/ "Documentation") for installation instructions.

== Frequently Asked Questions ==

= Have any questions about plugin usage? =

Read plugin [Documentation](http://magniumthemes.com/go/uwb-docs/ "Documentation")
...
* Added - WordPress 5.x support
* Added - PHP 7.3.x support
= 2.0 =
* Added - Now 99.9% of themes supported by plugin, even if theme change WooCommerce layouts or use Ajax on product page
* Added - Plugin code completely refactored to meet latest WordPress standards and support ANY themes
* Added - Now plugin add brands using WooCommerce hooks and actions, instead of JQuery code
* Added - Brands with different first letter case will be grouped to the same letter group in brand list
* Added - Brands with first digital or symbol value in name will be grouped to the same # group
* Added - Support for all languages in brand names
* Added - Ability to display brand logo image in product loops
* Added - Ability to display just brand text in product loops (without link)
